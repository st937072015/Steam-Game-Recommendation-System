...
$status_query = "SELECT user_id, personality_form_finish, test1_finish, good_or_bad1, txt_upload, good_or_bad2, test2_finish FROM user_account_table WHERE user_id = '".$user_id."'";
